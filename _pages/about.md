...
Previously, I was an NSF Postdoctoral Research Fellow in Atmospheric and Geospace Sciences with Ed Gerber at NYU. We developed a new explanation for the basic shape of the ozone layer, finding that textbook explanations in terms of photochemistry alone neglected the zeroth-order effects of transport. We discovered a photochemically destabilizing regime in Earth’s upper stratosphere, where ozone reductions aloft perturb ultraviolet fluxes to cause further ozone reductions below (the opposite of the well-known phenomenon of ``self-healing'', which occurs at lower altitudes). We also showed that model-predicted reductions in tropical lower stratospheric ozone due to global warming arise not only from strengthened upwelling, as was well known, but also from tropospheric expansion.
